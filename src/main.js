...
//targeting the element in the html
outputEl = document.querySelector("#outputEl")
//filtering through the array
const ballerBiz = businesses.filter(business => {
    //creating a variable and setting all false
    ballers = false
    //using the reduce method to add all orders for each biz
    const ordersTotal = business.orders.reduce((currentTotal, nextValue) => currentTotal += nextValue, 
0)
    console.log(ordersTotal)
    //condition bring companies out of false to true
